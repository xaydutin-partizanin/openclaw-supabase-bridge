...
export const supabaseBridgePlugin: ChannelPlugin<ResolvedBridgeAccount> = {
  ...
  meta: {
    ...
    selectionLabel: "Supabase Bridge (durable task mailbox)",
    docsPath: "/plugins/supabase-bridge",
    docsLabel: "Supabase Bridge",
    blurb: "Durable ChatGPT-to-OpenClaw task mailbox, event log, quota ledger, and report channel.",
