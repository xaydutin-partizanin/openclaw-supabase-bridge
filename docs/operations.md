...
4. Build/package v0.2.3 with `npm install`, `npm run validate`, and `npm pack`.
5. Install `npm-pack:.\local-openclaw-supabase-bridge-0.2.3.tgz`, enable the plugin, and restart the Gateway.
